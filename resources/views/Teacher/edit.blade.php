...
@section('content')
    <div class="section-header">
        <h2 class="h4 font-weight-bold mb-1">Edit Profil Guru</h2>
    </div>

    <div class="section-body">
        <div class="card">
            <div class="card-header">
                <h4>Edit detail profil guru</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('guru.update', $teacher->id) }}" method="POST" enctype="multipart/form-data"
                      id="form-berita">
                    @csrf
                    @method('PUT')
                    <div class="form-row">
                        <div class="col-md-6 mb-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="name" name="name"
                                       placeholder="Isi nama lengkap guru" value="{{$teacher->name}}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" id="email" name="email"
                                       placeholder="Contoh: user@email.com" value="P{{$teacher->email}}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="nip" name="nip"
                                       placeholder="Isi NIP guru" value="{{$teacher->NIP}}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="phone" name="phone"
                                       placeholder="Isi dengan nomor yang aktif" value="{{$teacher->phone}}"
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="form-group">
                                ...
                                <div id="native-dropzone" class="native-dropzone @error('image') border-error @enderror"
                                     tabindex="0"
                                     data-current-image-url="{{$teacher->image ? asset('storage/'. $teacher->image) : ''}}">
