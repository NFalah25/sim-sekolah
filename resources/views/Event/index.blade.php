        ...
        <div class="section-body">
            <div class="card">
                <div class="card-header d-flex flex-wrap justify-content-between align-items-center">
                    <h4 class="mb-3 mb-md-0">Daftar Agenda</h4>
                    <div class="d-flex flex-wrap align-items-center gap-2 justify-content-center">
                        ...
                        <a href="{{ route('acara.create') }}" class="btn btn-primary">
                            <i class="fas fa-plus mr-1"></i>Buat Agenda Baru
                        </a>
                    </div>
                </div>
                            ...
                            <tbody>
                                @forelse ($events as $index => $data)
                                    <tr class="text-center">
                                        ...
                                        @else
                                            <td>{{ \Carbon\Carbon::parse($data->start_time)->format('H:i') }} - {{ \Carbon\Carbon::parse($data->end_time)->format('H:i') }}</td>
                                        @endif
                                        <td>{{ $data->location }}</td>
                                        <td class="text-center">
                                            <a href="{{ route('acara.edit', $data->id) }}" class="btn btn-warning btn-sm">
