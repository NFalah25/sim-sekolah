                    ...
                    <div class="form-row">
                        <div class="col-md-6 mb-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="facility" name="facility" value="{{$fasilita->name}}"
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="description" name="description" rows="6"
                                          ...
                                          style="height: auto">{{$fasilita->description}}</textarea>
                            </div>
                            @error('description')
                            <div class="invalid-feedback">
                                {{ $message }}
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="form-group">
                                ...
                                <div id="native-dropzone" class="native-dropzone @error('image') border-error @enderror"
                                     tabindex="0"
                                     data-current-image-url="{{$fasilita->image ? asset('storage/'. $fasilita->image) : ''}}">
