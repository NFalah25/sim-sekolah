...
@section('content')
    <div class="section-header">
        <h2 class="h4 font-weight-bold mb-1">Edit Ekstrakurikuler</h2>
    </div>

    <div class="section-body">
        <div class="card">
            <div class="card-header">
                <h4>Tambah atau ubah detail ekstrakurikuler</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('ekstrakurikuler.update', $ekstra->id) }}" method="POST"
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="name" name="name"
                                       placeholder="Isi nama ekstrakurikuler" value="{{$ekstra->name}}"
                            ...
                            <div class="form-group">
                                ...
                                <input id="pembina" name="pembina"
                                       placeholder="Nama Pembina Ekstrakurikuler" value="{{$ekstra->advisor}}"
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="description" name="description" rows="6"
                                          ...
                                          style="height: auto">{{$ekstra->description}}</textarea>
                                @error('description')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="form-group">
                                ...
                                <div id="native-dropzone" class="native-dropzone @error('image') border-error @enderror"
                                     tabindex="0"
                                     data-current-image-url="{{ $ekstra->image ? asset('storage/' . $ekstra->image) : '' }}">
