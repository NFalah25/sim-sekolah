                    ...
                    <form action="{{ route('struktur.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control" style="height: 130px;"
                                        placeholder="Contoh: Meliputi Kepala Sekolah, Wakil, dan Bendahara.">{{ old('description') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="row gutters-xs">
                                ...
                                <div class="col-4 col-sm-3 col-md-2 mb-3">
                                    <label class="w-100">
                                        <input type="radio" name="icon" value="network" class="icon-radio-input">
                                        <div class="icon-radio-label text-center">
